...
if(CMAKE_HOST_WIN32)
    if(NOT protobuf_BUILD_PROTOC_BINARIES AND NOT EXISTS ${ROOT_INSTALLED_DIR}/x86-windows/tools/protobuf)
...
elseif(VCPKG_CMAKE_SYSTEM_NAME STREQUAL Linux)
    if(NOT protobuf_BUILD_PROTOC_BINARIES AND NOT EXISTS ${ROOT_INSTALLED_DIR}/x64-linux/tools/protobuf)
        message(FATAL_ERROR "Cross-targetting protobuf requires the x64-linux protoc to be available. Please install protobuf:x64-linux first.")
    endif()
endif()
...
if(CMAKE_HOST_WIN32)
    if(protobuf_BUILD_PROTOC_BINARIES)
        ...
        file(COPY ${ROOT_INSTALLED_DIR}/x86-windows/tools/protobuf DESTINATION ${CURRENT_PACKAGES_DIR}/tools)
    endif()
    ...
    if(protobuf_BUILD_PROTOC_BINARIES)
        ...
        file(COPY ${ROOT_INSTALLED_DIR}/x64-linux/tools/protobuf DESTINATION ${CURRENT_PACKAGES_DIR}/tools)
    endif()
    protobuf_try_remove_recurse_wait(${CURRENT_PACKAGES_DIR}/debug/bin)
    protobuf_try_remove_recurse_wait(${CURRENT_PACKAGES_DIR}/bin)
endif()
